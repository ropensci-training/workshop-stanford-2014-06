...
The `rnoaa` package allows you to retrieve a whole range of data from the National Ocean Atmosphere Administration.
...
```{r getdata, warning = FALSE, comment = NA, message = FALSE, results = 'hide'}
